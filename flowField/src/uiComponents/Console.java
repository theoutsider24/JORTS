...
public class Console implements Drawable{
	...
	public void submitText()
	{
		...
		String command = currentText.split(" ")[0];
		
		String [] args = Arrays.copyOfRange(currentText.split(" "), 1, currentText.split(" ").length);
		...
		Text temp = new Text(currentText, Main.font, 15);
		temp.move(new Vector2f(0,entryBox.getSize().y));
		//temp.move(-1280,-670);
		if(!succesful&&!currentText.equals(""))
		{
			temp.setString(currentText +" -- INVALID COMMAND");
