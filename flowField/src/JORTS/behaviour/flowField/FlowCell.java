...
public class FlowCell {
	...
	int vectorValue;
	public FlowCell targetCell=null;
	...
	//	{
		...
		hitBox.setSize(new Vector2f(CELL_SIZE,CELL_SIZE));
		
		integrationText = new Text(this.toString(),Main.font);
		integrationText.setCharacterSize(10);
		if(isGoal)integrationText.setColor(Color.YELLOW);
		else if(los)integrationText.setColor(Color.BLUE);
